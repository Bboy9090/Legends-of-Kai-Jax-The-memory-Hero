...
Transform the GitHub repo "Legends-of-Kai-Jax-The-memory-Hero" into a 10x more legendary, fun, and user-friendly experience with complete game documentation, character art, and studio-ready assets.
...
- Character Select Layout specs
- Matchup Art Prompts (4 hero vs enemy pairs)
- Memory Ledger Codex System
- Narrative Bible (tone rules, dialogue limits)
- Art & UX Bible (color law, animation rules)
- Engineering Specs (Tail Engine, Memory Save)
- Production Plan (team, tech stack, milestones)
