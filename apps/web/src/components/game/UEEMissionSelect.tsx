      ...
      {selectedMission && (
        <Card className="bg-slate-900/80 border-2 border-cyan-500/50 shadow-[0_0_30px_rgba(34,211,238,0.2)]">
          ...
          <CardContent className="space-y-4">
            <div>
              <h4 className="text-cyan-400 font-semibold mb-2">Objectives</h4>
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-cyan-600 to-purple-600 hover:from-cyan-500 hover:to-purple-500 text-white font-bold py-4"
            >
    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-[#0a0a0f] via-purple-950/30 to-[#0a0a0f] text-white p-6 overflow-auto">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <p className="text-amber-400/90 text-sm sm:text-base font-semibold tracking-[0.2em] uppercase mb-1">
            Ultimate Entertainment Enterprises presents
          </p>
          <h1 className="text-3xl sm:text-5xl font-black bg-gradient-to-r from-cyan-400 via-purple-400 to-amber-400 bg-clip-text text-transparent mb-2">
            Legends of Kai-Jax
          </h1>
          <p className="text-lg sm:text-xl text-purple-300 font-bold">
