...
const CharacterCard = ({ character, onGenerateImage, isGenerating }) => {
  ...
  const handleGenerate = async () => {
    const prompts = {
      kai: "Epic fantasy warrior portrait, young male with fierce expression, fire elemental powers, orange and red energy swirling around, tribal markings, muscular build, sabertooth hybrid warrior, dark mystical background with flames, cinematic lighting, hyper detailed, game character art style",
      jax: "Epic fantasy warrior portrait, young male with calculating expression, ice and storm elemental powers, blue and cyan energy surrounding, strategic pose, lean athletic build, sabertooth hybrid warrior, dark mystical background with lightning, cinematic lighting, hyper detailed, game character art style",
      kaijax: "Epic mythical fusion warrior, the Memory King, 9 glowing elemental tails (fire red, electric yellow, storm cyan, void purple, earth gray, water blue, nature green, light white, memory blue), powerful sovereign pose, hybrid sabertooth features with crown of light, all elements swirling together, transcendent power, dark epic fantasy background, hyper detailed game character art, legendary hero",
      boryn: "Weathered protective father figure, strong shield-bearer warrior, kind but fierce eyes, scars of many battles, standing protectively, street-smart survivor aesthetic, urban fantasy warrior, warm lighting against dark background, cinematic portrait",
      borax: "Ancient legendary sabertooth apex predator in humanoid form, intimidating presence, disciplined warrior stance, emotionally distant expression, law and sovereignty embodied, ice and storm elements, majestic and terrifying, dark mythic fantasy art style"
    };
