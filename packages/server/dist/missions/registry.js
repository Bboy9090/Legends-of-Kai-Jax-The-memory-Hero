import { MissionType, MissionDifficulty, DNAType } from './types';
/**
...
export const MISSION_REGISTRY = [
    ...
    ...Array.from({ length: 10 }, (_, i) => ({
        ...
        objectives: [{ id: 'obj1', description: 'Complete mission objective', type: 'defeat' }],
    ...
    ...Array.from({ length: 10 }, (_, i) => ({
        ...
        difficulty: MissionDifficulty.MASTER,
        objectives: [{ id: 'obj1', description: i === 9 ? 'Defeat the Final Boss' : 'Complete mission objective', type: 'defeat' }],
        rewards: {
            xp: 5000 + i * 500,
            currency: 2500 + i * 250,
 ...
 */
export function getMissionsByBook(book) {
 ...
 */
export function getAvailableMissions(completedMissionIds) {
